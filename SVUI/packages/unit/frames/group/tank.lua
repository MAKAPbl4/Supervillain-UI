...
function MOD:CreateFrame_Tank(...)
	...
	MOD:RefreshFrame_Tank(self,MOD.db['tank'])
...
function MOD:RefreshHeader_Tank(frame,db)
	frame:Hide()
	frame.db = db;
...
function MOD:RefreshFrame_Tank(frame,db)
...
MOD['GroupFrameLoadList']['tank']={'MAINTANK','SVUI_UNITTARGET'}